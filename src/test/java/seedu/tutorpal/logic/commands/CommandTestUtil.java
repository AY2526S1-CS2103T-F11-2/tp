...
public class CommandTestUtil {
    ...
    public static final String VALID_CLASS_AMY = "s4mon1600";
    public static final String VALID_CLASS_BOB = "s2wed1400";
    ...
    public static final String INVALID_ROLE_DESC = " " + PREFIX_ROLE + "teacher"; // only student/tutor allowed
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for addresses
    public static final String INVALID_CLASS_DESC = " " + PREFIX_CLASS + "s6mon1600"; // s6 not valid (only s1-s5)
